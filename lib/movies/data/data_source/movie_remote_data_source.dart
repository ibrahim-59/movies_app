...
import 'package:movies_app/movies/data/models/recommindation_model.dart';
...
abstract class BaseMovieRemoteDataSource {
  ...
  Future<List<RecommindationModel>> getMovieRecommindations(
...
class MovieRemoteDataSource extends BaseMovieRemoteDataSource {
  ...
  Future<List<RecommindationModel>> getMovieRecommindations(
    ...
    final response =
        await Dio().get(ApiConstance.movieRecommindationsPath(parameters.id));
    if (response.statusCode == 200) {
      return List<RecommindationModel>.from((response.data['results'])
          .map((e) => RecommindationModel.fromJson(e)));
    } else {
      throw ServerException(
          errorMessageModel: ErrorMessageModel.fromJson(response.data));
    }
